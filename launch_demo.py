...
conservées dans ``ASTRODYNAMICS/artifacts/demo_logs/``.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--gui-port", type=int, default=8501)
...
def build_services(args: argparse.Namespace, run_directory: Path) -> list[Service]:
    """Construit les commandes avec l'interpréteur actif de ``uv run``."""
